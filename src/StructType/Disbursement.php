...
/**
 * This class stands for Disbursement StructType
 * @subpackage Structs
 */
class Disbursement extends AbstractStructBase
{
    /**
     * The creditAccount
     * @var string|null
    ...
    /**
     * Constructor method for Disbursement
     * @uses Disbursement::setCreditAccount()
     * @uses Disbursement::setCreditAmount()
     * @uses Disbursement::setDebitAccount()
     * @uses Disbursement::setDebitAmount()
     * @uses Disbursement::setAccountName()
     * @uses Disbursement::setAccountRef()
     * @uses Disbursement::setAmount()
     * @uses Disbursement::setApproach()
     * @uses Disbursement::setAttachments()
     * @uses Disbursement::setCampaign()
     * @uses Disbursement::setCreatedDate()
     * @uses Disbursement::setDate()
     * @uses Disbursement::setDefinedValues()
     * @uses Disbursement::setFinal()
     * @uses Disbursement::setFund()
     * @uses Disbursement::setFundraiser()
     * @uses Disbursement::setLastModifiedDate()
     * @uses Disbursement::setLetter()
     * @uses Disbursement::setNote()
     * @uses Disbursement::setOffsettingRef()
     * @uses Disbursement::setReceipt()
     * @uses Disbursement::setRef()
     * @uses Disbursement::setType()
     * @uses Disbursement::setValuable()
