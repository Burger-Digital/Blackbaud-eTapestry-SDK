...
/**
 * This class stands for SegmentedOrder StructType
 * @subpackage Structs
 */
class SegmentedOrder extends AbstractStructBase
{
    /**
     * The accountName
     * @var string|null
    ...
    /**
     * Constructor method for SegmentedOrder
     * @uses SegmentedOrder::setAccountName()
     * @uses SegmentedOrder::setAccountRef()
     * @uses SegmentedOrder::setCreatedDate()
     * @uses SegmentedOrder::setDate()
     * @uses SegmentedOrder::setFinal()
     * @uses SegmentedOrder::setLastModifiedDate()
     * @uses SegmentedOrder::setOffsettingRef()
     * @uses SegmentedOrder::setOrderInfo()
     * @uses SegmentedOrder::setRef()
     * @uses SegmentedOrder::setSegments()
     * @uses SegmentedOrder::setTotalAmount()
     * @uses SegmentedOrder::setTotalNonDeductibleAmount()
     * @uses SegmentedOrder::setType()
     ...
     * @param int $type
     */
    public function __construct(?string $accountName = null, ?string $accountRef = null, ?string $createdDate = null, ?string $date = null, ?bool $final = null, ?string $lastModifiedDate = null, ?string $offsettingRef = null, ?\StructType\OrderInfo $orderInfo = null, ?string $ref = null, array $segments = [], ?float $totalAmount = null, ?float $totalNonDeductibleAmount = null, ?int $type = null)
    {
        $this
    ...
    public static function validateSegmentsForArrayConstraintsFromSetSegments(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $segmentedOrderSegmentsItem) {
            // validation for constraint: itemType
            if (false) {
                $invalidValues[] = is_object($segmentedOrderSegmentsItem) ? get_class($segmentedOrderSegmentsItem) : sprintf('%s(%s)', gettype($segmentedOrderSegmentsItem), var_export($segmentedOrderSegmentsItem, true));
            }
        }
