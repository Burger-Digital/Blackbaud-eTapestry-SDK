...
/**
 * This class stands for PagedQueryResultsResponse StructType
 * @subpackage Structs
 */
class PagedQueryResultsResponse extends AbstractStructBase
{
    /**
     * The count
     * @var int|null
    ...
    /**
     * Constructor method for PagedQueryResultsResponse
     * @uses PagedQueryResultsResponse::setCount()
     * @uses PagedQueryResultsResponse::setData()
     * @uses PagedQueryResultsResponse::setPages()
     * @uses PagedQueryResultsResponse::setStart()
     * @uses PagedQueryResultsResponse::setTotal()
     * @uses PagedQueryResultsResponse::setUsedCache()
     * @param int $count
     * @param mixed[] $data
     * @param int $pages
     * @param int $start
     ...
     * Set count value
     * @param int $count
     * @return \BurgerDigital\eTapestry\StructType\PagedQueryResultsResponse
     */
    ...
    public static function validateDataForArrayConstraintsFromSetData(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $pagedQueryResultsResponseDataItem) {
            // validation for constraint: itemType
            if (false) {
                $invalidValues[] = is_object($pagedQueryResultsResponseDataItem) ? get_class($pagedQueryResultsResponseDataItem) : sprintf('%s(%s)', gettype($pagedQueryResultsResponseDataItem), var_export($pagedQueryResultsResponseDataItem, true));
            }
        }
