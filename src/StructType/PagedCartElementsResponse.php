...
/**
 * This class stands for PagedCartElementsResponse StructType
 * @subpackage Structs
 */
class PagedCartElementsResponse extends AbstractStructBase
{
    /**
     * The count
     * @var int|null
    ...
    /**
     * Constructor method for PagedCartElementsResponse
     * @uses PagedCartElementsResponse::setCount()
     * @uses PagedCartElementsResponse::setData()
     * @uses PagedCartElementsResponse::setPages()
     * @uses PagedCartElementsResponse::setStart()
     * @uses PagedCartElementsResponse::setTotal()
     * @uses PagedCartElementsResponse::setUsedCache()
     * @param int $count
     * @param mixed[] $data
     * @param int $pages
     * @param int $start
     ...
     * Set count value
     * @param int $count
     * @return \BurgerDigital\eTapestry\StructType\PagedCartElementsResponse
     */
    ...
    public static function validateDataForArrayConstraintsFromSetData(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $pagedCartElementsResponseDataItem) {
            // validation for constraint: itemType
            if (false) {
                $invalidValues[] = is_object($pagedCartElementsResponseDataItem) ? get_class($pagedCartElementsResponseDataItem) : sprintf('%s(%s)', gettype($pagedCartElementsResponseDataItem), var_export($pagedCartElementsResponseDataItem, true));
            }
        }
