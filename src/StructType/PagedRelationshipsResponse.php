...
/**
 * This class stands for PagedRelationshipsResponse StructType
 * @subpackage Structs
 */
class PagedRelationshipsResponse extends AbstractStructBase
{
    /**
     * The count
     * @var int|null
    ...
    /**
     * Constructor method for PagedRelationshipsResponse
     * @uses PagedRelationshipsResponse::setCount()
     * @uses PagedRelationshipsResponse::setData()
     * @uses PagedRelationshipsResponse::setPages()
     * @uses PagedRelationshipsResponse::setStart()
     * @uses PagedRelationshipsResponse::setTotal()
     * @uses PagedRelationshipsResponse::setUsedCache()
     * @param int $count
     * @param mixed[] $data
     * @param int $pages
     * @param int $start
    ...
    public static function validateDataForArrayConstraintsFromSetData(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $pagedRelationshipsResponseDataItem) {
            // validation for constraint: itemType
            if (false) {
                $invalidValues[] = is_object($pagedRelationshipsResponseDataItem) ? get_class($pagedRelationshipsResponseDataItem) : sprintf('%s(%s)', gettype($pagedRelationshipsResponseDataItem), var_export($pagedRelationshipsResponseDataItem, true));
            }
        }
