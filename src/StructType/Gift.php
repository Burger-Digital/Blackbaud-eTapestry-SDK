...
/**
 * This class stands for Gift StructType
 * @subpackage Structs
 */
class Gift extends AbstractStructBase
{
    /**
     * The creditAccount
     * @var string|null
    ...
    /**
     * Constructor method for Gift
     * @uses Gift::setCreditAccount()
     * @uses Gift::setCreditAmount()
     * @uses Gift::setDebitAccount()
     * @uses Gift::setDebitAmount()
     * @uses Gift::setAccountName()
     * @uses Gift::setAccountRef()
     * @uses Gift::setAmount()
     * @uses Gift::setApproach()
     * @uses Gift::setAttachments()
     * @uses Gift::setCampaign()
     * @uses Gift::setCreatedDate()
     * @uses Gift::setDate()
     * @uses Gift::setDefinedValues()
     * @uses Gift::setFinal()
     * @uses Gift::setFund()
     * @uses Gift::setFundraiser()
     * @uses Gift::setGeneratedReceipt()
     * @uses Gift::setGiftAidAmount()
     * @uses Gift::setGiftAidClaimedDate()
     * @uses Gift::setGiftAidStatus()
     * @uses Gift::setLastModifiedDate()
     * @uses Gift::setLetter()
     * @uses Gift::setNonDeductibleAmount()
     * @uses Gift::setNote()
     * @uses Gift::setOffsettingRef()
     * @uses Gift::setOrderDetail()
     * @uses Gift::setOrderInfo()
     * @uses Gift::setOriginalAccountName()
     * @uses Gift::setOriginalAccountRef()
     * @uses Gift::setOriginalTransactionRef()
     * @uses Gift::setReceipt()
     * @uses Gift::setRecognitionName()
     * @uses Gift::setRecognitionType()
     * @uses Gift::setRef()
     * @uses Gift::setSegmentedTransactionRef()
     * @uses Gift::setSoftCredit()
     * @uses Gift::setTributeAccountName()
     * @uses Gift::setTributeAccountRef()
     * @uses Gift::setType()
     * @uses Gift::setValuable()
