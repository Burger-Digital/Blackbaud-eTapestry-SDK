...
/**
 * This class stands for PagedDefinedFieldsResponse StructType
 * @subpackage Structs
 */
class PagedDefinedFieldsResponse extends AbstractStructBase
{
    /**
     * The count
     * @var int|null
    ...
    /**
     * Constructor method for PagedDefinedFieldsResponse
     * @uses PagedDefinedFieldsResponse::setCount()
     * @uses PagedDefinedFieldsResponse::setData()
     * @uses PagedDefinedFieldsResponse::setPages()
     * @uses PagedDefinedFieldsResponse::setStart()
     * @uses PagedDefinedFieldsResponse::setTotal()
     * @uses PagedDefinedFieldsResponse::setUsedCache()
     * @param int $count
     * @param mixed[] $data
     * @param int $pages
     * @param int $start
    ...
    public static function validateDataForArrayConstraintsFromSetData(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $pagedDefinedFieldsResponseDataItem) {
            // validation for constraint: itemType
            if (false) {
                $invalidValues[] = is_object($pagedDefinedFieldsResponseDataItem) ? get_class($pagedDefinedFieldsResponseDataItem) : sprintf('%s(%s)', gettype($pagedDefinedFieldsResponseDataItem), var_export($pagedDefinedFieldsResponseDataItem, true));
            }
        }
